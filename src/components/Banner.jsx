...
const Banner = () => {
  ...
  return (
    <div className="flex bg-gray-600 rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10">
      {/*--------------------------------left side----------------------- */}
      <div className="flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5">
        <div className="text-xll sm:text-2xl md:text-3xl lg:text-5xl font-semibold text-white ">
