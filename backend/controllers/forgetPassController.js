...
export const forgotPassword = async (req, res) => {
  try {
    ...
    const resetLink = `http://localhost:5173/reset-password?token=${token}&userType=${userType}` || `https://hospitalmanagement-4.onrender.com/reset-password?token=${token}&userType=${userType}`;
